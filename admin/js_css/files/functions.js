...
*/
	...
	$(".subNav li:last-child a, .formRow:last-child, .userList li:last-child, table[class!='lastbordered'] tbody tr:last-child td, .breadLinks ul li ul li:last-child, .fulldd li ul li:last-child, .niceList li:last-child").addClass("noBorderB")
...
*/
	...
	//===== Form elements styling =====//, input:file
	$(".check, .check :checkbox, input:radio, .select").uniform();
});

$(document).ready(function(e) {
	$('.setcontentlang').change(function(){
		$.cookie('admin_contentlng',$(this).val(),{expires:10000});
...
function tinyMCE_init(objects){
	tinyMCE.init({
		...
		relative_urls : false,
		skin_variant : "silver",
		plugins : "imagemanager, safari,pagebreak,style,layer,table,save,advhr,advimage,advlink,iespell,insertdatetime,preview,media,searchreplace,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,inlinepopups",
		// Theme options
		...
		theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,code,|,preview,|,sub,sup,|,charmap,iespell,media,advhr,|,ltr,rtl,|,fullscreen,|,forecolor,backcolor",
