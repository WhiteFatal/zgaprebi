<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../storage/wysiwygs/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../storage/wysiwygs/'; // absolute or relative from this script path, required.
